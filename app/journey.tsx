      ...
      <div className="px-4 md:px-6 max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-lg leading-relaxed">
          ...
          <div>
            ...
            <p>Early on, I undertook several development paths in parallel:</p>
            <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
              <li>Cross-platform app development: Working with Flutter</li>
              <li>Native app development: Using Android Studio with Kotlin</li>
          ...
          <div>
            ...
            <p>
              Through this journey, I recognized that mastering web development
              provides a strong foundation applicable to many other areas of
              tech. As a result, I am currently specializing as a web developer,
              confident that these skills will help me branch out into other
              areas of development and engineering in the future.
            </p>
          </div>
        </div>
      </div>
