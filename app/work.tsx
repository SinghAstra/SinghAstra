...
import ChatSDKXBackground from "./background/chatsdkx";
import ComponentXBackground from "./background/componentx";
import ReadmeXBackground from "./background/readmex";
import SummaryXBackground from "./background/summaryx";
import UnderstandXBackground from "./background/understandx";

const Work = () => {
  return (
    <div className="w-full py-12 md:py-24 lg:py-32 " id="projects">
