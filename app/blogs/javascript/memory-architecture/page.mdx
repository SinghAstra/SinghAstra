...
## Unit 1: Memory Architecture 🧠

### 1.0 The Physical Reality (RAM)
...
### 1.1 The Stack Memory (Static & Structured)
...
The Stack is managed by a CPU register called the Stack Pointer.
...
### 1.2 The Heap Memory (Dynamic & Unstructured)

#### A. Definition

The Heap is a massive pool of memory reserved for Dynamic Allocation.
