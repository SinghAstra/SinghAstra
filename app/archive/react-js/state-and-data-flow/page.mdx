...
### _1. If we have a Great-Grandparent component that holds `User` data, and a Great-Grandchild that needs to display the `User Name`, how do we get the data there using only Props?_
