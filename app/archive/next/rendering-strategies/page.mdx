...
| ------------- | ----------- | ------------- | ----------------------------- |
| Static (SSG)  | ⚡⚡        | ❌ Stale      | Marketing, Docs               |
| Dynamic (SSR) | 🐢          | ⚡⚡          | User Dashboards, Private data |
| ISR           | ⚡⚡        | ✅ Background | Large Blogs, Product Catalogs |
| PPR           | ⚡ (Shell)  | ✅ (Holes)    | E-commerce, Social Feeds      |
